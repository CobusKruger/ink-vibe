<?php
/**
 * Title: Bladsy-argetipe D — Gemeenskapsblad
 * Slug: ink-foundation/archetype-d-community-utility
 * Categories: ink-foundation, page
 * Block Types: core/post-content
 * Description: Gemeenskaps- en hulpmiddelblad-skanderaal: 'n duidelike funksionele opskrif, die funksionele module eerste en 'n verduideliking ná die kontroles.
 */
?>
...
<!-- wp:pattern {"slug":"ink-foundation/profile-summary"} /-->
...
<section class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--s-24);padding-right:var(--wp--preset--spacing--s-24);padding-bottom:var(--wp--preset--spacing--s-64);padding-left:var(--wp--preset--spacing--s-24)">
	<!-- wp:group {"align":"wide","className":"is-style-emphasis","lock":{"move":true,"remove":true},"style":{"spacing":{"blockGap":"var:preset|spacing|s-12"}},"layout":{"type":"constrained"}} -->
	<div class="wp-block-group alignwide is-style-emphasis">
		<!-- wp:heading {"level":2,"fontSize":"xl"} -->
		<h2 class="wp-block-heading has-xl-font-size">Meer oor hierdie blad</h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"fontSize":"md"} -->
		<p class="has-md-font-size">Plaas die verduidelikende teks hier, ná die funksionele kontroles. Vervang dit met die werklike inhoud van die blad.</p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</section>
