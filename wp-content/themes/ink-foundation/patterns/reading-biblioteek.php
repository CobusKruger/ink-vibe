<?php
/**
 * Title: Leesblad — Biblioteekitem
 * Slug: ink-foundation/reading-biblioteek
 * Categories: ink-foundation
 * Inserter: no
 * Description: Leessjabloon vir 'n biblioteekitem — tipe-etiket, titel, byskrif en inhoud (Storie 10.1, FR-52).
 *
 ...
 *
 * Post-Epic-19 fidelity pass (biblioteek workstream): brought the header up to the
 * same reading-page baseline already established by reading-storie.php/
 * reading-gedig.php/reading-opleiding.php (Library.tsx has no dedicated
 * single-article reading route to mirror 1:1, so this follows the site's own
 * established reading-page convention instead — pill type badge via the shared
 * `.ink-lees-tipe` class, centered larger title, centered avatar byline). Uses the
 * same accent/sage tint as reading-opleiding.php — biblioteek is the other
 * "informational/resource" genre (a curated reference shelf), not a creative-work
 * reading experience, so it deliberately skips the drop-cap serif prose treatment
 * too.
 *
...
$ink_type_label = function_exists( 'ink_foundation_term' )
	? ink_foundation_term( 'biblioteek_item', 'Biblioteekitem' )
	: 'Biblioteekitem';
?>
