...
<section class="wp-block-group alignfull ink-uitdaging-cta">
	...
	<div class="wp-block-group">
		...
		<!-- wp:heading {"textAlign":"center","level":2,"className":"ink-uitdaging-cta__titel","fontSize":"3xl"} -->
		<h2 class="wp-block-heading has-text-align-center ink-uitdaging-cta__titel has-3-xl-font-size"><?php esc_html_e( 'Jou storie wag om geskryf te word', 'ink-foundation' ); ?></h2>
		<!-- /wp:heading -->
